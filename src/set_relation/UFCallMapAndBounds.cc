...
string UFCmap::symUFC( std::string &ufcName )
{
...
void UFCmap::insert( UFCallTerm &ufcterm )
{
...
string UFCmap::find( UFCallTerm &ufcterm )
{
    std::string symCons("");
...
UFCallTerm UFCmap::find( string &symbol )
{
